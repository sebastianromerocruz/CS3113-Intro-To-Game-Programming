...
bool Map::isSolidTileAt(Vector2 position, float *xOverlap, float *yOverlap)
{
    ...
    *yOverlap = 0.0f;
    ...
    float tileCentreX =
        mLeftBoundary + tileXIndex * mTileSize + mTileSize / 2.0f;
    float tileCentreY =
        mTopBoundary + tileYIndex * mTileSize + mTileSize / 2.0f;
    ...
    */
    *xOverlap =
        fmaxf(0.0f, (mTileSize / 2.0f) - fabs(position.x - tileCentreX));
    *yOverlap =
        fmaxf(0.0f, (mTileSize / 2.0f) - fabs(position.y - tileCentreY));

...
<h3 align=center>II Garland Moon, Imperial Year MMXXVI</h3>

<p align=center><strong><em>Song of the day</strong>: <a href="https://youtu.be/mI_yB_TXe1s?si=IB-uI49qczZIWNbD"><strong><u>MY START</u></strong></a> by LEEHI (2016)</em></p>
...
4. [**The `Entity` Class: _Making A Game Object_**](#4)
...
```
horizontal grid location ("col"): 5 % 3 = 2
vertical grid location ("row"): 5 // 3 = 1
```
...
So that's step 1. Now, all we have to do is programmatically _cycle_ through these indices in order to give the impression of animation. Have you ever seen one of these?
...
1. Choosing a "speed" of animation that is completely independent of the frame rate (although it can, if you want, be dependent on it. Why not?)

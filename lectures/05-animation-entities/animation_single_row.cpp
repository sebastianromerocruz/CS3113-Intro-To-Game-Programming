...
void initialise()
{
    InitWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "Animation (Single Row)");

    gTeardropTexture = LoadTexture(PROTAG_FILEPATH);
...
void render()
{
    ...
    // Render Link
    renderObject(&gTeardropTexture, &gPosition, &gScale, TEXTURE_TYPE);

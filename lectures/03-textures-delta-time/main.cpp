...
void initialise()
{
    ...
    gEdelgardTexture = LoadTexture(EDELGARD_FP);
...
void render()
{
    ...
    Rectangle textureArea = {
        ...
        static_cast<float>(gEdelgardTexture.width),
        static_cast<float>(gEdelgardTexture.height)
    };
...
{ 
    CloseWindow(); 
    UnloadTexture(gEdelgardTexture);
}
